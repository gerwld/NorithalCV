...
<body <?php body_class(); ?>>
  ...
  <?php get_template_part('assets/sections/header-parallax'); ?>
    <div class="hd-navbar">
    ...
    <?php get_template_part('assets/sections/header-block-main'); ?>
    </div>
  </header>

  <?php get_template_part('assets/sections/video-dt-block'); ?>
  <?php get_template_part('assets/sections/posts-gallery-block'); ?>
  <?php get_template_part('assets/sections/benefits-block'); ?>
  <?php get_template_part('assets/sections/plans-block'); ?>
  <?php get_template_part('assets/sections/transp-block'); ?>
  <?php get_template_part('assets/sections/features-block'); ?>
  <?php get_template_part('assets/sections/slider-block-bl'); ?>
  <?php get_template_part('assets/sections/lastpost-block'); ?>